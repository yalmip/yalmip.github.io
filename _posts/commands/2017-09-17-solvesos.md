...
Images:mini-category.gif  [!Sum-of-squares], [!Semidefinite relaxations]

[solvesos] calculates sum-of-squares (SOS) decompositions.
...
There is a large number of additional features in YALMIPs sum-of-squares module. To learn more check out the [Tutorials.SumOfSquares| sum-of-squares examples].

### See also
[clean], [optimize], [sdpvar], [sos], [sosd], [solvemoment], [sdisplay]
