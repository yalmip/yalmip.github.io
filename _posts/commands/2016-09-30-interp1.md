...
If you have nonconvex data, but want to create an LP-based epigraph representation of the lower convex envelope, you can use the flag **'envelope'** and the data set will automatically be pruned
