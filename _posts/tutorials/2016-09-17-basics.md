...
**Tip:** If you ommitt the ; or simply write the name, the expression will be displayed and you can check its properties
{: .notice--info}
...
**Tip:** The constraint list can be displayed and you can check that you actually have defined the type of constraints that you intended to
{: .notice--info}
